class ArrayUtils
  ...
  def self.tabuada(num)
    lista = []
    (1..num).each do |i|
      lista.push(self.multiplos(10, i))
    end
    lista
  end
  
  def self.ultimo(lista)
    ult = lista[(lista.length - 1)] 
  end
end

lista = [6, 12, 18]

#puts ArrayUtils.ultimo(lista)

#puts ArrayUtils.multiplos(5,2)

print ArrayUtils.tabuada(3)
